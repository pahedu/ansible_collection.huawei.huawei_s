...
from ansible.module_utils.network.huawei_s.huawei_s import run_commands, get_config
from ansible.module_utils.network.huawei_s.huawei_s import get_defaults_flag, get_connection
from ansible.module_utils.network.huawei_s.huawei_s import huawei_s_argument_spec
from ansible.module_utils.network.huawei_s.huawei_s import check_args as huawei_s_check_args
