...
from ansible.module_utils.network.huawei_s.huawei_s import run_commands, get_capabilities
from ansible.module_utils.network.huawei_s.huawei_s import normalize_interface
